...
import { Download, Pen, Type, Check, ArrowLeft, Move } from "lucide-react";
...
export default function SignPage() {
  ...
  const handleSign = async () => {
    ...
    try {
      ...
      // Convert signature to image and embed in PDF
      const signatureImage = await pdfDoc.embedPng(signatureData);
      const { width, height } = firstPage.getSize();
      
      // Calculate signature position
      const scaledX = (signaturePosition.x / pdfScale);
      const scaledY = height - (signaturePosition.y / pdfScale) - 50; // Adjust for PDF coordinate system
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="relative">
            <Card 
              className="p-4 h-[600px] bg-muted overflow-hidden"
              ref={pdfContainerRef}
